(function() {
  var Backbone, BoundModel, BoundProperty, Gunther, ItemSubView, SwitchedView, ViewSwitch, tag, _, _fn, _i, _len, _ref, _ref1,
    __slice = [].slice,
  ...
  Gunther.Template.prototype.attribute = function() {
  ...
  Gunther.Template.prototype.property = function() {
    var args, el, name, value;
    name = arguments[0], value = arguments[1], args = 3 <= arguments.length ? __slice.call(arguments, 2) : [];
    el = this.current;
    if (value instanceof BoundProperty) {
  ...
  Gunther.Template.prototype.toggleClass = function(className, model, properties, toggle) {
    var element, performToggle, property, _i, _len;
  ...
  ItemSubView = (function(_super) {
    ...
    ItemSubView.naiveSort = function(collection, parentElement, elementKey) {
      ...
      for (_i = 0, _len = items.length; _i < _len; _i++) {
        item = items[_i];
        _results.push(parentElement.appendChild(item));
      }
      return _results;
    };
  ...
  Gunther.addPartial = function(key, partial) {
