(function() {
  var Backbone, BoundModel, BoundProperty, Gunther, ItemSubView, SwitchedView, ViewSwitch, _, _ref,
    __slice = [].slice,
  ...
  Gunther.addPartial = function(key, partial) {
    ...
    if (Gunther.Template.prototype[key] != null) {
      throw new Error("Partial \"" + key + "\" already exists");
    }
  ...
  Gunther.Template.prototype.p = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
