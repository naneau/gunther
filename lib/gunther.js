(function() {
  ...
  Gunther.Template = (function() {
    ...
    Template.prototype.text = function(text) {
      return this.current.append(document.createTextNode(text));
    };
    Template.prototype.t = function() {
      var args, tagName;
      tagName = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      return this.createChild.apply(this, [tagName].concat(__slice.call(args)));
    };
    ...
    Template.prototype.sub = function(options) {
