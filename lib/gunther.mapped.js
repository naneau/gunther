(function() {
  ...
  Gunther.Helper = (function() {
    ...
    Helper.createHtmlElement = function(description) {
      var classNameFull, classes, element, id, join, tagName;
      ...
      if (id != null) {
        element.attr('id', id[0].substring(1));
      }
      classes = description.match(/\.(-?[_a-zA-Z]+[_a-zA-Z0-9-]*)/ig);
      join = function(memo, val) {
        return memo + ' ' + val.substring(1);
      };
  ...
  BoundModel = (function() {
    function BoundModel(model, propertyName, template) {
      var _this = this;
      this.model = model;
    ...
    BoundModel.prototype.getValueInEl = function(el) {
      return this.template.renderInto(el, this.model.get(this.propertyName));
    };
  ...
  Gunther.Template = (function() {
    ...
    Template.prototype.bindModel = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (function(func, args, ctor) {
        ctor.prototype = func.prototype;
